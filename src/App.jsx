...
function App() {
  ...
  const veggieDatabase = {
    ...
    Brassicas: [
      ...
      { name: 'Broccoli Raab (Rapini)', icon: 'https://em-content.zobj.net/source/apple/391/broccoli_1f966.png' },
      { name: 'Cabbage', icon: 'https://em-content.zobj.net/source/apple/391/cabbage_1f96c.png' },
      { name: 'Cauliflower', icon: 'https://em-content.zobj.net/source/apple/391/broccoli_1f966.png' },
      { name: 'Brussels Sprouts', icon: 'https://em-content.zobj.net/source/apple/391/broccoli_1f966.png' },
    ],
    RootVegetables: [
      { name: 'Carrot', icon: 'https://em-content.zobj.net/source/apple/391/carrot_1f955.png' },
      { name: 'Beet', icon: 'https://em-content.zobj.net/source/apple/391/beet_1f954.png' },
      { name: 'Radish', icon: 'https://em-content.zobj.net/source/apple/391/radish_1f95e.png' },
    ],
    Alliums: [
      ...
      { name: 'Leek', icon: 'https://em-content.zobj.net/source/apple/391/onion_1f9c5.png' },
      { name: 'Shallot', icon: 'https://em-content.zobj.net/source/apple/391/onion_1f9c5.png' },
      { name: 'Chives', icon: 'https://em-content.zobj.net/source/apple/391/leafy-green_1f96c.png' },
    ],
    Legumes: [
      { name: 'Beans (Bush)', icon: 'https://em-content.zobj.net/source/apple/391/green-beans_1f966.png' },
      { name: 'Beans (Pole)', icon: 'https://em-content.zobj.net/source/apple/391/green-beans_1f966.png' },
      { name: 'Peas', icon: 'https://em-content.zobj.net/source/apple/391/peas_1f95c.png' },
      { name: 'Snap Peas', icon: 'https://em-content.zobj.net/source/apple/391/peas_1f95c.png' },
    ],
    FruitingVegetables: [
    ...
    Cucurbits: [
      ...
      { name: 'Squash', icon: 'https://em-content.zobj.net/source/apple/391/pumpkin_1f383.png' },
                  ...
                  <div className="space-y-1">
                    ...
                    {Object.keys(veggieDatabase).map((category) => (
                      <button
                        ...
                        className="w-full text-left px-3 py-2 bg-white hover:bg-gray-100 rounded text-sm text-black"
                      >
                        {category}
                      </button>
                    ))}
